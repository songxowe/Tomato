			...
			<div id="searchVideoForm" style="padding: 10px">
				...
				<!-- <a href="#" class="easyui-linkbutton"
				       ...
				       <a href="#" class="easyui-linkbutton"
				         ...
				         onclick="video_obj.recommend();">主推</a>
				       <a href="#" class="easyui-linkbutton"
  	...
  	$(function(){
  		...
  		video_obj = {
  			...
  			recommend : function(){
					...
					if(rows.length == 12){
						$.messager.confirm("消息","确认要主推所选的视频吗",function(flag){
							if(flag){
								$.ajax({
						           type : "post",
						           url : "videoAction_show?length="+rows.length,
						           data : {videos:rows}, 
						           beforeSend : function(){
						           // 显示载入状态
  		...
  		$('#videoDataGrid').datagrid({    
	    	    url:'videoAction_list',   // 一个URL从远程站点请求数据
	    	    title : '视频列表',
	          ...
	          rownumbers : true, // 行号
	    	    columns:[[{ // -- 列开始 ---------
	 	         ...
	 	         editor : {
	 	        	  type : "numberbox",
	 	        	  options : {required:false,min:0,max:1}
	 	          }
	 	        },      
	    	    ]],
